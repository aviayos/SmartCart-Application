...
import StatisticsComponent from './statistics.jsx';
            ...
            <Col xs={12}>
              ...
              <div className='sidebar-nav-container'>
                <SidebarNav style={{marginBottom: 0}} ref={(c) => this._nav = c}>
                  ...
                  <SidebarNavItem  name="Products" glyph='icon-outlined-paper-pencil'>
                    <SidebarNav>
                      <SidebarNavItem glyph='icon-stroke-gap-icons-Tools' name='List Of Products' href={::this.getPath('gallery')} />
                      <SidebarNavItem glyph='icon-fontello-chart-area' name='Add A Product' href={::this.getPath('charts/chartjs')} />
                    </SidebarNav>
                  </SidebarNavItem>
                  ...
                  <SidebarNavItem glyph='icon-ikons-bar-chart-2 float-right-rtl' name={<span>Statistics <Label className='bg-brown50 fg-white'>4</Label></span>}>
                  </SidebarNavItem>
                  ...
                  <SidebarNavItem glyph='icon-fontello-chart-area' name='Analytics'>
                        <SidebarNav>
                      <SidebarNavItem glyph='icon-dripicons-graph-line' name='maps interface' href={::this.getPath('charts/c3js')} />
                      <SidebarNavItem glyph='icon-feather-pie-graph' name='routes' href={::this.getPath('charts/morrisjs')} />
                          <SidebarNavItem name='driver analysis' href={::this.getPath('charts/rubix/line')} />
                          <SidebarNavItem name='vehicle  analysis' href={::this.getPath('charts/rubix/area')} />
                          <SidebarNavItem name='fuel  analysis' href={::this.getPath('charts/rubix/barcol')} />
                          <SidebarNavItem name='schedule  efficiency' href={::this.getPath('charts/rubix/mixed')} />
                          <SidebarNavItem name='fleet general effiency' href={::this.getPath('charts/rubix/piedonut')} />
                        </SidebarNav>
                  </SidebarNavItem>
                  ...
                  <SidebarNavItem glyph='icon-ikons-login' name='Signout' href={::this.getPath('login')} />
...
export default class SidebarContainer extends React.Component {
  ...
  async componentDidMount() {
    ...
    this.setState({fisrtName: user.data.first_name, lastName: user.data.last_name});
  }
    ...
    return (
      <div id='sidebar'>
          ...
          <Grid>
            <Row className='fg-white'>
              <Col xs={4} collapseRight>
                <img src='/imgs/app/logo_small.png' width='40' height='40' />
              </Col>
              <Col xs={8} collapseLeft id='avatar-col'>
                <div style={{top: 23, fontSize: 16, lineHeight: 1, position: 'relative'}}>
                  {`${this.state.fisrtName} ${this.state.lastName}`}
                </div>
                <div>
        ...
        <SidebarControls>
          ...
          <SidebarControlBtn glyph='icon-fontello-equalizer' sidebar={1} />
        ...
        <div id='sidebar-container'>
          ...
          <Sidebar sidebar={1}>
            <StatisticsComponent path_to_filter = {::this.getPath('forms/x-editable')} Filter={this.props.Filter} />
          </Sidebar>
