...
public class OrderNetworkFragment extends Fragment {

    private static final String TAG = "orderNetworkFragment";
    private static final String URL_KEY = "UrlKey";
    private HTTPCallback<String> callback;
    private OrderProductsTask orderProductsTask;
    protected final static String FETCH_PRODUCTS_URL = ConnectionUtils.getInstance().getUrlHost()+"/app/api/order";


    public static OrderNetworkFragment getInstance(FragmentManager fragmentManager) {
        OrderNetworkFragment fetchProductsNetworkFragment = new OrderNetworkFragment();
    ...
    public void onAttach(Context context) {
        ...
        orderProductsTask.setCallback(callback);
    }
    ...
    public void orderProducts(String userId) {
        orderProducts();
        orderProductsTask = new OrderProductsTask(callback, userId);
        orderProductsTask.execute(FETCH_PRODUCTS_URL);
    }
    ...
    public void orderProducts() {
        if (orderProductsTask != null) {
            orderProductsTask.cancel(true);
        }
    }

    private class OrderProductsTask extends AsyncTask<String, Integer, Result> {

        private HTTPCallback<String> callback;
        private String mUserId;


        public OrderProductsTask(HTTPCallback<String> callback, String userId) {
        ...
        protected Result doInBackground(String... urls) {
            ...
            if (!isCancelled() && urls != null && urls.length > 0) {
                ...
                try {
                    ...
                    Result resultString = orderProductsUrl(url);
        ...
        private Result orderProductsUrl(URL url) throws IOException, JSONException {
